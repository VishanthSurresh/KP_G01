...
//  public IssueSearchResult GetTrimmedIssueResult(String keyTerm){
//	  if(!ownerInfoResults.containsKey(keyTerm)) AddOwnerInfoToCache(keyTerm);
//	  
//	  var returnData = new IssueSearchResult(keyTerm);
//	  returnData.setKeyTermData(ownerInfoResults.get(keyTerm).getData().stream().limit(20).collect(Collectors.toList()));
//	  return returnData;
//  }
//  public IssueSearchResult GetOwnerInfo(String channelId){
//      if(!ownerInfoResults.containsKey(channelId))
//          AddOwnerInfoToCache(channelId);
//      return ownerInfoResults.get(channelId);
//  }
// 
//public void AddOwnerInfoToCache(String channelId){
//	var result = new IssueSearchResult(channelId);
//    result.PopulateData(helper);
//    ownerInfoResults.put(channelId, result);
//  }
